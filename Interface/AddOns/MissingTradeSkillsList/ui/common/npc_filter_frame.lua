...
MTSLUI_NPC_FILTER_FRAME = {
    ...
    BuildFactions = function(self)
        self.factions = {
            ...
            -- Alliance & Neutral (469 + 10000)
            {
                ["name"] =  MTSL_LOGIC_FACTION_REPUTATION:GetFactionNameById(469) .. " & " .. MTSLUI_TOOLS:GetLocalisedLabel("neutral"),
                ["id"] = "_Alliance",
            },
            -- Horde (id: 67)
            {
            ...
            -- Horde & Neutral (67 + 10000)
            {
                ["name"] =  MTSL_LOGIC_FACTION_REPUTATION:GetFactionNameById(67) .. " & " .. MTSLUI_TOOLS:GetLocalisedLabel("neutral"),
                ["id"] = "_Horde"
            },
            -- Neutral (10000)
            {
