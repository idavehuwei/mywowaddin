...
MTSLUI_MINIMAP = {
    ...
    HookEvents = function(self)
        ...
        self.ui_frame:SetScript("OnEnter", function(frame)
            ...
            GameTooltip:AddLine(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Ctrl + Left Click: Open Account explorer", 1, 1, 1)
            GameTooltip:AddLine(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Shift + Left Click: Open Database explorer", 1, 1, 1)
            GameTooltip:AddLine("", 1, 1, 1)
            GameTooltip:AddLine(MTSLUI_FONTS.COLORS.TEXT.NORMAL .. "Right click drag: Move the minimap button", 1, 1, 1)
            GameTooltip:Show()
        end)
