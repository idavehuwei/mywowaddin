...
local backdrop = {
	bgFile = "Interface\\AddOns\\Salad_Cthun\\Images\\background.tga",
	--bgFile = "Interface\\AddOns\\Salad_Cthun\\Images\\bg.blp",
...
eye:SetBackdrop({bgFile = "Interface\\AddOns\\Salad_Cthun\\Images\\eye.blp"})
eye:Hide()
...
check_frame:SetScript("OnEvent", function(self, event, arg1)
	...
	texdot:SetTexture("Interface\\AddOns\\Salad_Cthun\\Images\\playerdot2.tga")
	texdot:Hide()
...
function getRaidInfo()
	for i=1,40 do
		...
		elseif ( class == "WARLOCK" or class == "HUNTER") then
