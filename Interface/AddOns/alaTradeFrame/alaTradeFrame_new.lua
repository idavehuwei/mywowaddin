...
do	--	MAIN
	...
	do	--	db	--	CREDIT ATLASLOOT & MTSL
		...
		local recipe_info = {
			...
			[3491]  = { true, 1,  2,  3491,  3848, 100, 135, 150, 165,   1,   1, { 2841, 2880, 3470, 818, 2319, }, { 6, 4, 2, 1, 1, }, { 1383, 2836, 2998, 3136, 3355, 3478, 4258, 4596, 5511, 10276, }, 600, },
			...
			[6517]  = { true, 1,  2,  6517,  5540, 115, 140, 155, 170,   1,   1, { 2841, 3466, 5498, 3478, }, { 6, 1, 2, 2, }, { 1383, 2836, 2998, 3136, 3355, 3478, 4258, 4596, 5511, 10276, }, 720, },
			...
			[9931]  = { true, 1,  2,  9931,  7920, 205, 230, 240, 250,   1,   1, { 3860, }, { 12, }, { 2836, 3355, 4258, }, 5000, },
			...
			[9954]  = { true, 1,  2,  9954,  7938, 240, 245, 255, 265,   1,   1, { 3860, 6037, 7909, 3864, 5966, 7966, }, { 10, 8, 3, 3, 1, 2, }, { 5164, 7230, 11177, }, 9000, },
			...
			[16742] = { true, 1,  2, 16742, 12620, 300, 320, 330, 340,   1,   1, { 12360, 12655, 7076, 12799, 12800, }, { 6, 16, 6, 2, 1, }, nil, nil, 12725, },
			...
			[16744] = { true, 1,  2, 16744, 12619, 300, 320, 330, 340,   1,   1, { 12360, 12655, 7080, 12361, 12364, }, { 10, 20, 6, 2, 1, }, nil, nil, 12726, },
			...
			[16745] = { true, 1,  2, 16745, 12618, 300, 320, 330, 340,   1,   1, { 12360, 12655, 7076, 7080, 12364, 12800, }, { 8, 24, 4, 4, 2, 2, }, nil, nil, 12727, },
			...
			[22928] = { true, 1,  3, 22928, 18511, 300, 320, 330, 340,   1,   1, { 8170, 7082, 12753, 12809, 15407, 14341, }, { 30, 12, 4, 8, 4, 8, }, nil, nil, 18519, },
			[20854] = { true, 1,  3, 20854, 16983, 300, 320, 330, 340,   1,   1, { 17012, 17010, 17011, 14341, }, { 15, 3, 6, 2, }, nil, nil, 17023, },
			[22926] = { true, 1,  3, 22926, 18509, 300, 320, 330, 340,   1,   1, { 8170, 12607, 15416, 15414, 15407, 14341, }, { 30, 12, 30, 30, 5, 8, }, nil, nil, 18517, },
			[26279] = { true, 5,  3, 26279, 21278, 300, 320, 330, 340,   1,   1, { 12810, 7080, 7082, 15407, 14227, }, { 6, 4, 4, 2, 2, }, nil, nil, 21548, },
			[22923] = { true, 1,  3, 22923, 18508, 300, 320, 330, 340,   1,   1, { 8170, 18512, 15420, 15407, 14341, }, { 12, 8, 60, 4, 4, }, nil, nil, 18516, },
			[22922] = { true, 1,  3, 22922, 18506, 300, 320, 330, 340,   1,   1, { 8170, 7082, 11754, 15407, 14341, }, { 12, 6, 4, 2, 4, }, nil, nil, 18515, },
			...
			[22921] = { true, 1,  3, 22921, 18504, 300, 320, 330, 340,   1,   1, { 8170, 12804, 15407, 14341, }, { 12, 12, 2, 4, }, nil, nil, 18514, },
			...
			[22927] = { true, 1,  3, 22927, 18510, 300, 320, 330, 340,   1,   1, { 8170, 12803, 7080, 18512, 15407, 14341, }, { 30, 12, 10, 8, 3, 8, }, nil, nil, 18518, },
			...
			[24266] = { true, 1,  4, 24266, 19931, 300, 315, 322, 330,   3,   3, { 12938, 19943, 12804, 13468, }, { 1, 1, 6, 1, }, nil, nil, nil, nil, 180368, },
			...
			[22761] = { true, 1,  6, 22761, 18254, 275, 315, 335, 355,   1,   1, { 18255, 3713, }, { 1, 1, }, nil, nil, 18267, },
			...
			[24801] = { true, 1,  6, 24801, 20452, 285, 325, 345, 365,   1,   1, { 20424, 3713, }, { 1, 1, }, nil, nil, nil, { 8313, }, },
			...
			[22967] = { true, 1,  7, 22967, 17771, 300, 310, 315, 320,   1,   1, { 18562, 12360, 17010, 18567, }, { 1, 10, 1, 3, }, { 14401, }, 0, },
			...
			[8776]  = { true, 1,  8,  8776,  7026,  10,  50,  67,  85,   1,   1, { 2996, 2320, }, { 1, 1, }, { 1103, 1300, 1346, 1703, 2399, 2627, 2855, 3004, 3363, 3484, 3523, 3704, 4159, 4193, 4576, 5153, 5567, 11048, 11049, 11050, 11051, 11052, 11557, }, 45, },
			...
			[27658] = { true, 5,  8, 27658, 22246, 225, 240, 255, 270,   1,   1, { 4339, 11137, 8343, }, { 4, 4, 2, }, nil, nil, 22307, },
			...
			[12091] = { true, 1,  8, 12091, 10040, 250, 255, 260, 265,   1,   1, { 4339, 8343, }, { 5, 3, }, nil, nil, 10325, },
			...
			[22813] = { true, 1,  8, 22813, 18258, 285, 285, 290, 295,   1,   1, { 14048, 8170, 18240, 14341, }, { 2, 4, 1, 1, }, nil, nil, nil, { 5519, }, },
			...
			[22866] = { true, 1,  8, 22866, 18405, 300, 315, 330, 345,   1,   1, { 14048, 9210, 14342, 7080, 7078, 14344, 14341, }, { 16, 10, 10, 12, 12, 6, 6, }, nil, nil, 18414, },
			...
			[22867] = { true, 1,  8, 22867, 18407, 300, 315, 330, 345,   1,   1, { 14048, 14256, 12662, 12808, 14341, }, { 12, 20, 6, 8, 2, }, nil, nil, 18415, },
			[22870] = { true, 1,  8, 22870, 18413, 300, 315, 330, 345,   1,   1, { 14048, 12809, 12360, 14341, }, { 12, 4, 1, 2, }, nil, nil, 18418, },
			...
			[22902] = { true, 1,  8, 22902, 18486, 300, 315, 330, 345,   1,   1, { 14048, 14342, 13926, 14341, }, { 6, 4, 2, 2, }, nil, nil, 18487, },
			[22868] = { true, 1,  8, 22868, 18408, 300, 315, 330, 345,   1,   1, { 14048, 7078, 7910, 14341, }, { 12, 10, 2, 2, }, nil, nil, 18416, },
			...
			[22869] = { true, 1,  8, 22869, 18409, 300, 315, 330, 345,   1,   1, { 14048, 14342, 13926, 14341, }, { 12, 6, 2, 2, }, nil, nil, 18417, },
			...
			[27660] = { true, 1,  8, 27660, 22249, 300, 315, 330, 345,   1,   1, { 14048, 14344, 12810, 14227, }, { 6, 4, 4, 4, }, nil, nil, 22309, },
			...
			[12895] = { true, 1,  9, 12895, 10713, 200, 205, 205, 205,   1,   1, { 10648, 10647, }, { 1, 1, }, { 7406, 7944, 8738, }, 0, },
			...
			[12716] = { true, 1,  9, 12716, 10577, 205, 205, 205, 205,   1,   1, { 10559, 3860, 10505, 10558, 7068, }, { 2, 4, 5, 1, 1, }, { 8126, }, 0, },
			...
			[12907] = { true, 1,  9, 12907, 10726, 215, 255, 265, 275,   1,   1, { 3860, 6037, 10558, 7910, 4338, }, { 10, 4, 1, 2, 4, }, { 7406, 7944, }, 0, },
			...
			[12754] = { true, 1,  9, 12754, 10586, 225, 235, 255, 275,   2,   2, { 10561, 9061, 10507, 10560, }, { 1, 1, 6, 1, }, { 8126, 8738, }, 0, },
			[8895]  = {  nil, 1,  9,  8895,  7189, 225, 245, 255, 265,   1,   1, { 10026, 10559, 4234, 9061, 10560, }, { 1, 2, 4, 2, 1, }, },
			...
			[12758] = { true, 1,  9, 12758, 10588, 235, 265, 275, 285,   1,   1, { 10543, 9061, 3860, 10560, }, { 1, 4, 4, 1, }, { 8126, 8738, }, 0, },
			...
			[23079] = { true, 1,  9, 23079, 18637, 275, 285, 290, 295,   1,   1, { 16000, 18631, 14047, }, { 2, 1, 2, }, nil, nil, 18655, },
			...
			[28327] = { true, 1,  9, 28327, 22728, 275, 295, 305, 315,   1,   1, { 15994, 10561, 10558, }, { 2, 1, 1, }, nil, nil, 22729, },
		...
		--	cached
		local spell_info = {  };		--	[sid] = { sname, sname_lower, }
				...
				if success then
					...
					if pid then
						...
						if pname then
							...
							spell_info[sid] = { pname, pname_lower, };
						-- else
					...
					if info then
						...
						if sname then
							...
							pt[sname_lower] = ptn;
							tinsert(ptn, sid);
							spell_info[sid] = { sname, sname_lower, };
						-- else
							-- RequestLoadSpellData(sid);
						end
					end
	...
	do	--	func
		...
		function NS.init_hash_known_recipe()
			for GUID, VAR in pairs(alaTradeFrameSV.var) do
		...
		local function process_search(list, searchText, searchNameOnly)
			...
			for index = #list, 1, -1 do
				...
				if info then
					local removed = true;
					local cid = info[index_cid];
					local name_lower = NS.db_spell_name_lower(sid);
					local item_lower = cid and item_func(cid);
					if (name_lower and strfind(name_lower, searchText)) or (item_lower and strfind(item_lower, searchText)) then
						removed = false;
					else
						local reagent_ids = info[index_reagents_id];
						if reagent_ids then
		...
		--
			...
			function NS.ui_defaultSkillListButton_OnEnter(self)
				if SET.default_skill_button_tip then
					local frame = self.frame;
					local index = self:GetID() + FauxScrollFrame_GetOffset(self.scroll);
	...
	do	-- 	tooltip
		...
		function NS.price_gen_info_by_sid(phase, sid, num, lines, stack_level, is_enchanting)	--	merc not checked
			...
			if stack_level <= 4 and (stack_level == 0 or not recipe_black_list_sid[sid]) then
				local pid = info[index_pid];
						...
						if nsids > 0 then
							for index = 1, #sids do
								...
								if NS.db_get_pid_by_sid(sid) == pid then
									local p2, c2 = NS.price_gen_info_by_sid(phase, sid, num, detail_lines, stack_level + 1);
									p = p or p2;
									if c2 then
						...
						if nv.id == nid then
							if (A and nv.reacts == "Alliance") or (H and nv.reacts == "Horde") or (N and nv.reacts == "Neutral") or (HOS and nv.reacts == "Hostile") then
								...
								if nv.special_action and nv.special_action[MTSL_LOCALE] then
									if #(nv.special_action[MTSL_LOCALE]) > 36 then
						...
						for _, qv in pairs(quests) do
							if qv.id == qid then
								...
								if qv.special_action and qv.special_action[MTSL_LOCALE] then
									if #(qv.special_action[MTSL_LOCALE]) > 36 then
						...
						for _, ov in pairs(objects) do
							if ov.id == oid then
								...
								if ov.special_action and ov.special_action[MTSL_LOCALE] then
									if #(ov.special_action[MTSL_LOCALE]) > 36 then
...
do	--	INITIALIZE
	...
	function NS.MODIFY_SAVED_VARIABLE()
		...
		alaTradeFrameSV._version = 200525.0;
...
do	--	EXTERN SETTING
	...
	function extern_setting.get_tradeskill_board_shown()
		return alaTradeFrameSV.set.board.shown;
	end
	function extern_setting.get_tradeskill_board_lock()
		return alaTradeFrameSV.set.board.locked;
	end
